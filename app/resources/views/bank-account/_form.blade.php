    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <fieldset>
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <label class="control-label" for="BankAccount_name">Razão social</label>
                        <input type="BankAccount[name]" id="BankAccount_name" class="form-control" value="{{ $model->name }}" />
                    </div>
            ...
            <fieldset>
                ...
                <div class="row mb-10">
                    <div class="col-sm-6 vcheck">
                        <label>
                            <input type="checkbox" class="checkbox style-0" name="">
