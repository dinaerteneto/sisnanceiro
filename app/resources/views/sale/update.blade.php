    ...
    <section id="contact" class="home-section text-center">
        <div class="container">
            <div class="row">			
                ...
                <div class="col-sm-6">
                    <form id="form-sale" method="post" action="/sale/update/{{$sale['id']}}">
                        @csrf
                                ...
                                <table class="table table-hover" id="table-items">
                                    ...
                                    @if($sale['items'])                                
                                        ...
                                        <tr id="A{{ $i }}">
                                            ...
                                            <td>
                                                <a href="javascript: void(0)" class="text-danger del-item" data-id="{{ $item['store_product_id'] }}" ><i class="fa fa-times-circle"></i></a>
                        ...
                        <div class="pull-right">
                            <input type="submit" class="btn btn-primary input-lg" value="ALTERAR VENDA">
                        </div>
                    </form>
                </div>
                ...
                <div class="row">
                    <div class="hidden-xs teclas">
                        <b>F2</b> = Nova Busca <b>|</b> <b>F3</b> = Adicionar Produto <b>|</b> <b>F4</b> = Alterar Venda <b>
                    </div>                
                </div>
            </div>
        </div>
