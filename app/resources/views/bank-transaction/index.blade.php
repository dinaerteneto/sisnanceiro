        ...
        Main.dataTableOptions.columns = [{
            ...
            { data: 'net_value' },
            {
                ...
                mRender: function(data, type, row) {
                    ...
                    if(row.status != 'green') {
                         html += '<a href="/bank-transaction/set-paid/' + row.id + '" rel="tooltip" data-placement="top" data-original-title="Pago" class="btn btn-xs btn-success open-modal" target="#remoteModal"><i class="fa fa-check"></i></a> ';
                    }
