                ...
                if (row.bank_category_id == 1 || row.credit_card_id != null) {
                    ...
                    if(row.status != 3) {
                        if(row.is_credit_card_invoice != null && row.is_credit_card_invoice != 0) {
                            html += `<a href="/bank-transaction/partial-pay/${row.id}" rel="tooltip" data-placement="top" data-original-title="Pagar parcialmente" class="btn btn-xs btn-primary open-modal" target="#remoteModal"><i class="fa fa-check"></i></a> `;
                        }
                        var label = 'Pagar';
                        if(row.main_category_id == 3) {
                            label = 'Receber';
                        }
                        html += `<a href="/bank-transaction/set-paid/${row.id}" rel="tooltip" data-placement="top" data-original-title="${label}" class="btn btn-xs btn-success set-paid"><i class="fa fa-check"></i></a> `;
                    }
                    if(row.bank_category_id == 6 || row.bank_category_id == 7) {
                        ...
                        html += `<a href="/bank-transaction/${row.url_main}/update/${row.id}" rel="tooltip" data-placement="top" data-original-title="Alterar lançamento" class="btn btn-xs btn-warning open-modal" target="#remoteModal"><i class="fa fa-pencil"></i></a> `;
