...
abstract class Mask {
    ...
    public static function floatVar($fValue, $sMil=null, $iMinPrecision=null) {
        if ($fValue !== null) {
            if ($iMinPrecision === 0 && ($fValue >= 1 OR $fValue <= -1)) {
    ...
    public static function currency($dValue) {
        ...
        if ($sCurrency === null) {
            $sCurrency = self::getNullValue('currency');
            self::setNullValue('currency', null);
        }
        return $sCurrency;
    }
